...
# represents the ith log message formatted as a string "{function_id}:{"start" | "end"}:{timestamp}". 
# For example, "0:start:3" 
# means a function call with function ID 0 started at the beginning of timestamp 3, and 
...
class Solution:
    def exclusiveTime(self, n: int, logs: List[str]) -> List[int]:
        ...
        # how much time was THIS function actually running?
        for log in logs:
            ...
            if typ == "start":
                ...
                # current running function pauses and we calculate how much it ran for currently and add temporaily to result , 
